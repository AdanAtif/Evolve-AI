...
export default function Home() {
  return (
    <>
      <div className="h-100 bg-cover bg-center h-[85vh] flex flex-col items-center justify-center rounded-b-lg bg-[url('/b.jpg')]" >
        <h1 className="text-3xl font-bold mb-6 text-center text-slate-950">Welome To Evolve AI</h1>
        <p className="text-lg mb-6 w-full md:w-1/2 text-center text-stone-800 font-semibold">
          friendly and knowledgeable virtual assistant Our chatbot is built using the OpenAI ChatGPT API
        </p>
        <Button />
      </div>
      <div className="h-100 bg-cover bg-center flex flex-col md:flex-row items-center justify-center pt-8">
        ...
        <div className="md:w-1/2">
          <Image src="/d.jpg" alt="Logo" width={500} height={500} className="w-full rounded-md" />
        </div>
      </div>
<Footer/>
    </>
